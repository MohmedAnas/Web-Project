"""
Django settings for rbcomputer project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-rbcomputer-development-key-change-in-production')
...
# Add Render.com hosts for production
if not DEBUG:
